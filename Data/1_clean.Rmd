...
# Age 10 dataset (Rutter scale, CDS, positive activities): negative values become NA
is.na(age_10[, grep("j127", names(age_10)):grep("j178b", names(age_10))]) <- age_10[, grep("j127", names(age_10)):grep("j178b", names(age_10))] < 0
is.na(age_10[, grep("m43", names(age_10)):grep("m61", names(age_10))]) <- age_10[, grep("m43", names(age_10)):grep("m61", names(age_10))] < 0
