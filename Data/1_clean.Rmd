...
age_10 %<>% select(
  ...
  meb4_1, meb4_6, meb4_16, meb4_21, meb4_26, meb4_46, meb4_51, # Medical conditions
...
data_clean %<>% mutate(dv_med_10 = case_when(
  if_any(meb4_1:meb4_51, ~. == 1) ~ "Yes"
))
data_clean %<>% select(-(meb4_1:meb4_51))
