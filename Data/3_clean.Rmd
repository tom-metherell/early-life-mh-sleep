...
for(dataset in c("age_5d", "age_5e", "age_5f", "age_10", "age_10dv", "age_16", "age_16arith", "age_16dv", "age_16school", "age_26", "age_30", "age_42", "age_46", "CLOSER_env", "CLOSER_BMI", "CLOSER_SES", "response", "activpal", "diary", "vdb", "winkler")){
  data_clean <- full_join(data_clean, get(dataset), by = "bcsid")
}

# Removing individual datasets
rm(list = c("birth", "age_5d", "age_5e", "age_5f", "age_10", "age_10dv", "age_16", "age_16arith", "age_16dv", "age_16school", "age_26", "age_30", "age_42", "age_46", "CLOSER_env", "CLOSER_BMI", "CLOSER_SES", "response", "activpal", "diary", "vdb", "winkler"))
```
